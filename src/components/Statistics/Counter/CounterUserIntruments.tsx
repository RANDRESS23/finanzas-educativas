...
export default function CounterUserIntruments({
  ...
  return (
    <div className="shadow dark:shadow-slate-700 p-14 sm:p-16 xl:p-18">
      <div className="flex items-center">
        <div className="flex-shrink-0">
          <span className="text-4xl leading-none font-bold">{instrument}</span>
          <h3 className="font-normal text-gray-500 dark:text-gray-300 whitespace-nowrap overflow-hidden animate-typing">
            {description}
          </h3>
        </div>
        <div className="ml-5 w-0 flex items-center justify-end flex-1 text-base font-bold p-10">
          {!isLoading ? (
