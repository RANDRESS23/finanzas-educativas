...
export default function ItemListDropDown({
  ...
  return (
    <div className="group relative flex items-center gap-x-6 rounded-lg p-4 text-base leading-6 hover:bg-gray-50 dark:hover:bg-slate-900/60">
      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-100/80 group-hover:bg-white dark:bg-slate-900/60 dark:group-hover:bg-slate-800">
        <Icon />
      </div>
