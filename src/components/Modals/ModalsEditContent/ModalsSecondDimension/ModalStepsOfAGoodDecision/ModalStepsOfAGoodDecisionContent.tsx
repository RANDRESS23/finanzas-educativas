...
import ModalFormStepsOfAGoodDecision from "./ModalFormStepsOfAGoodDecision";
...
export default function ModalStepsOfAGoodDecisionContent({
  open,
  setOpen,
  setOpen2,
  cancelButtonRef,
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                      ...
                      <div className="mt-4 w-full">
                        <ModalFormStepsOfAGoodDecision
                          setOpen={setOpen}
                          setOpen2={setOpen2}
                          idStepOfAGoodDecision={idStepOfAGoodDecision}
                        />
                      </div>
                    </div>
                  </div>
