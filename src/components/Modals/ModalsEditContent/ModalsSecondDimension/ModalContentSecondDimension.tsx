...
import ModalFormAGoodDecision from "./ModalAGoodDecision/ModalFormAGoodDecision";
import ModalFormTakeIntoAccountAGoodDecision from "./ModalTakeIntoAccountAGoodDecision/ModalFormTakeIntoAccountAGoodDecision";
import ModalStepsOfAGoodDecision from "./ModalStepsOfAGoodDecision/ModalStepsOfAGoodDecision";
...
export default function ModalContentSecondDimension({
  open,
  setOpen,
  cancelButtonRef,
  title,
                ...
                <div className="bg-white dark:bg-slate-950/40 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-boston-blue-600 sm:mx-0 sm:h-10 sm:w-10 p-2">
                      <UserCheck className="text-6xl md:text-4xl text-white" />
                    </div>
