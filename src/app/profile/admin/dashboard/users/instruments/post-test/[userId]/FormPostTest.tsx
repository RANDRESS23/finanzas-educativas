...
import { UserPostTest } from "@prisma/client";
...
export default function FormPostTest({ userId }: IProps) {
  ...
  useEffect(() => {
    (async () => {
      try {
        const response = await api<UserPostTest>(`/user/post-test/${userId}`);
    ...
    <form className="flex flex-col sm:grid md:grid-cols-2 gap-7 md:gap-10 md:place-content-center w-full">
      ...
      <InputRadio
        ...
        options={[
          ...
          opt.value === questions.question10 ? { ...opt, checked: true } : opt,
        )}
        disabled
      />
      ...
      <InputRadio
        ...
        options={[
          ...
          opt.value === questions.question11 ? { ...opt, checked: true } : opt,
        )}
        disabled
      />
      ...
      <InputRadio
        ...
        options={[
          ...
          opt.value === questions.question12 ? { ...opt, checked: true } : opt,
        )}
        disabled
      />
      ...
      <InputRadio
        ...
        options={[
          ...
          opt.value === questions.question13 ? { ...opt, checked: true } : opt,
        )}
        disabled
      />
      ...
      <InputRadio
        ...
        options={[
          ...
          opt.value === questions.question14 ? { ...opt, checked: true } : opt,
        )}
        disabled
      />
      ...
      <InputRadio
        ...
        options={[
          ...
          opt.value === questions.question15 ? { ...opt, checked: true } : opt,
        )}
        disabled
      />
    </form>
